    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            @include('categorias.forms.form_create_categoria')
        </div>
...
<script>
    function eventsModalNuevaCategoria(){
        ...
        $('#modalNuevaCategoria').on('hidden.bs.modal', function (e) {
    ...
    function registrarCategoria(){
        ...
        if (result.isConfirmed) {
            ...
            const urlRegistrarCategoria     =   @json(route('categorias.store'));
